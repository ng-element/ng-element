export const RouterList: any[] = [
  ...
  },
  {
    ...
    menuList: [
      ...
      { link: 'color-picker', name: 'ColorPicker 颜色选择器 xxx' },
      { link: 'date-picker', name: 'DatePicker 日期选择器 xxx' },
      { link: 'datetime-picker', name: 'DateTimePicker 日期时间选择器 xxx' },
      { link: 'form', name: 'Form 表单 xxx' },
      ...
      { link: 'slider', name: 'Slider 滑块 xxx' },
      { link: 'switch', name: 'Switch 开关' },
      { link: 'time-picker', name: 'TimePicker 时间选择器 xxx' },
      { link: 'time-select', name: 'TimeSelect 时间选择器 xxx' },
  ...
  },
  {
    ...
    menuList: [
      ...
      { link: 'menu', name: 'NavMenu 导航菜单 xxx' },
