...
@Component({
  ...
  template: `
  <button nel-button [nelPlain]="true" (click)="open1()">右上角</button>
  <button nel-button [nelPlain]="true" (click)="open2()">右下角</button>
  <button nel-button [nelPlain]="true" (click)="open3()">左下角</button>
  <button nel-button [nelPlain]="true" (click)="open4()">左上角</button>
  `
})
